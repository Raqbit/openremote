                ...
                switch (propertyType) {
                    case CHANNEL_STATE:
                        if (deviceType != VelbusDeviceType.VMB4AN) {
                            properties.add(new PropertyDescriptor("ch"+i+"State", "CH" + i, "CH" + i, ValueType.STRING));
                        }
                        break;
                    case LED_STATE:
                        if (deviceType != VelbusDeviceType.VMB4AN) {
                            properties.add(new PropertyDescriptor("ch"+i+"LedState", "CH" + i + "LED State", "CH" + i + propertyType.getPropertySuffix(), ValueType.STRING));
                        }
                        break;
                    case LOCK_STATE:
