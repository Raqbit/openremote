...
public class RelayProcessor extends OutputChannelProcessor {
    ...
    protected final static List<PropertyDescriptor> SUPPORTED_PROPERTIES = Arrays.asList(
        new PropertyDescriptor("ch1State", "CH1", "CH1", ValueType.STRING),
        new PropertyDescriptor("ch2State", "CH2", "CH2", ValueType.STRING),
        new PropertyDescriptor("ch3State", "CH3", "CH3", ValueType.STRING),
        new PropertyDescriptor("ch4State", "CH4", "CH4", ValueType.STRING),
        new PropertyDescriptor("ch5State", "CH5", "CH5", ValueType.STRING),
        new PropertyDescriptor("ch1Setting", "CH1 Setting", "CH1_SETTING", ValueType.STRING),
        new PropertyDescriptor("ch2Setting", "CH2 Setting", "CH2_SETTING", ValueType.STRING),
        new PropertyDescriptor("ch3Setting", "CH3 Setting", "CH3_SETTING", ValueType.STRING),
        new PropertyDescriptor("ch4Setting", "CH4 Setting", "CH4_SETTING", ValueType.STRING),
        new PropertyDescriptor("ch5Setting", "CH5 Setting", "CH5_SETTING", ValueType.STRING),
        ...
        new PropertyDescriptor("ch1LedState", "CH1 LED State", "CH1_LED", ValueType.STRING),
        new PropertyDescriptor("ch2LedState", "CH2 LED State", "CH2_LED", ValueType.STRING),
        new PropertyDescriptor("ch3LedState", "CH3 LED State", "CH3_LED", ValueType.STRING),
        new PropertyDescriptor("ch4LedState", "CH4 LED State", "CH4_LED", ValueType.STRING),
        new PropertyDescriptor("ch5LedState", "CH5 LED State", "CH5_LED", ValueType.STRING),
