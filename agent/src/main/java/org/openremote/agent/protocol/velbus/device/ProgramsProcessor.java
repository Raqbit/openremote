...
public class ProgramsProcessor extends ChannelProcessor {
    ...
    protected static final List<PropertyDescriptor> STATIC_PROPERTIES = Arrays.asList(
        ...
        new PropertyDescriptor("alarm1WakeTime", "Alarm 1 Wake Time", "ALARM1_WAKE_TIME", ValueType.STRING),
        new PropertyDescriptor("alarm2WakeTime", "Alarm 2 Wake Time", "ALARM2_WAKE_TIME", ValueType.STRING),
        new PropertyDescriptor("alarm1BedTime", "Alarm 1 Bed Time", "ALARM1_BED_TIME", ValueType.STRING),
        new PropertyDescriptor("alarm2BedTime", "Alarm 2 Bed Time", "ALARM2_BED_TIME", ValueType.STRING),
        new PropertyDescriptor("program", "Current Program", "Program", ValueType.STRING)
    );
