...
public class AnalogInputProcessor extends FeatureProcessor {
    ...
    protected static final List<PropertyDescriptor> IO_PROPERTIES = Arrays.asList(
        ...
        new PropertyDescriptor("sensor1Text", "Sensor 1 Text", "SENSOR1_TEXT", ValueType.STRING, true),
        new PropertyDescriptor("sensor2Text", "Sensor 2 Text", "SENSOR2_TEXT", ValueType.STRING, true),
        new PropertyDescriptor("sensor3Text", "Sensor 3 Text", "SENSOR3_TEXT", ValueType.STRING, true),
        new PropertyDescriptor("sensor4Text", "Sensor 4 Text", "SENSOR4_TEXT", ValueType.STRING, true),
        new PropertyDescriptor("sensor1Type", "Sensor 1 Type", "SENSOR1_TYPE", ValueType.STRING, true),
        new PropertyDescriptor("sensor2Type", "Sensor 2 Type", "SENSOR2_TYPE", ValueType.STRING, true),
        new PropertyDescriptor("sensor3Type", "Sensor 3 Type", "SENSOR3_TYPE", ValueType.STRING, true),
        new PropertyDescriptor("sensor4Type", "Sensor 4 Type", "SENSOR4_TYPE", ValueType.STRING, true),
        new PropertyDescriptor("sensor1Mode", "Sensor 1 Mode", "SENSOR1_MODE", ValueType.STRING, true),
        new PropertyDescriptor("sensor2Mode", "Sensor 2 Mode", "SENSOR2_MODE", ValueType.STRING, true),
        new PropertyDescriptor("sensor3Mode", "Sensor 3 Mode", "SENSOR3_MODE", ValueType.STRING, true),
        new PropertyDescriptor("sensor4Mode", "Sensor 4 Mode", "SENSOR4_MODE", ValueType.STRING, true)
    );
