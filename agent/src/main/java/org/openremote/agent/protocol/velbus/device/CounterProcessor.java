...
public class CounterProcessor extends FeatureProcessor {
    ...
    public static final List<PropertyDescriptor> SUPPORTED_PROPERTIES = Arrays.asList(
        ...
        new PropertyDescriptor("counter1Units", "Counter 1 Units", "COUNTER1_UNITS", ValueType.STRING, true),
        new PropertyDescriptor("counter2Units", "Counter 2 Units", "COUNTER2_UNITS", ValueType.STRING, true),
        new PropertyDescriptor("counter3Units", "Counter 3 Units", "COUNTER3_UNITS", ValueType.STRING, true),
        new PropertyDescriptor("counter4Units", "Counter 4 Units", "COUNTER4_UNITS", ValueType.STRING, true),
