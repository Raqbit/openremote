...
public class ThermostatProcessor extends FeatureProcessor {
    ...
    protected static final List<PropertyDescriptor> THERMOSTAT_PROPERTIES = Arrays.asList(
        new PropertyDescriptor("heater", "Heater", "HEATER", ValueType.STRING, true),
        new PropertyDescriptor("boost", "Boost", "BOOST", ValueType.STRING, true),
        new PropertyDescriptor("pump", "Pump", "PUMP", ValueType.STRING, true),
        new PropertyDescriptor("cooler", "Cooler", "COOLER", ValueType.STRING, true),
        new PropertyDescriptor("tempAlarm1", "Temp Alarm 1", "TEMP_ALARM1", ValueType.STRING, true),
        new PropertyDescriptor("tempAlarm2", "Temp Alarm 2", "TEMP_ALARM2", ValueType.STRING, true),
        new PropertyDescriptor("tempAlarm3", "Temp Alarm 3", "TEMP_ALARM3", ValueType.STRING, true),
        new PropertyDescriptor("tempAlarm4", "Temp Alarm 4", "TEMP_ALARM4", ValueType.STRING, true),
        new PropertyDescriptor("tempState", "Thermostat State", "TEMP_STATE", ValueType.STRING),
        ...
        new PropertyDescriptor("tempMode", "Thermostat Mode", "TEMP_MODE", ValueType.STRING),
